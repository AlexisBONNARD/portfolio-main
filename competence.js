...
buttons.forEach(button => {
    ...
    button.addEventListener('click',() =>{
        ...
        if (nom == "Réaliser")
        {
            ...
            divText.innerHTML += '<p>AC31.03 | Intégrer des solutions dans un environnement de développement, de test ou de production </p>'
        }
        ...
        else if(nom == "Optimiser")
        {
            ...
            divText.innerHTML += "<p>AC32.01 | Anticiper les résultats de diverses métriques (temps d’exécution, occupation mémoire, …) </p>"
            divText.innerHTML += "<p>AC32.02 | Profiler, analyser et justifier le comportement d’un code existant </p>"
            divText.innerHTML += "<p>AC32.03 | Choisir et utiliser des bibliothèques et méthodes dédiées au domaine d’application (imagerie, immersion, IA, jeux vidéo, parallélisme, …) </p>"
        }
        ...
        else if(nom == "Collaborer")
        {
            ...
            divText.innerHTML += '<p>AC36.01 | Organiser et partager une veille numérique</p>'
            divText.innerHTML += '<p>AC36.02 | Identifier les principaux coûts et gains de la (ou des) mission(s) </p>'
